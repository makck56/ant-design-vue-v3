...
import expandDarkSvg from '../assets/wSAkBuJFbdxsosKKpqyq.svg';
import expandSvg from '../assets/expand.svg';
import unExpandSvg from '../assets/unexpand.svg';
import unExpandDarkSvg from '../assets/OpROPHYqWmrMDBFMZtKF.svg';
